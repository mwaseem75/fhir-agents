...
FHIR Agents platform. It handles the intake conversation — establishing
...
Workflow per session:
  ...
  2. As soon as the ID is available (from the patient or from an orchestrator
     ...
     and medications from the FHIR server — no confirmation step, no delay
...
from config import LLM_MODEL, TEMP_TRIAGE, GROQ_API_KEY, GROQ_BASE_URL
...
# Two write tools let the agent document findings directly into the FHIR server
