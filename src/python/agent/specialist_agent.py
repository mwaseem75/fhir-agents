...
Responsibilities:
  1. Retrieve the patient's complete clinical record from the FHIR server
  ...
  6. Write FHIR ServiceRequests to the FHIR server for every referral recommended
...
from config import LLM_MODEL, TEMP_SPECIALIST, GROQ_API_KEY, GROQ_BASE_URL
